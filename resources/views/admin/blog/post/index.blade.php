                    ...
                    <div class="table-overflow">
                        <table id="dt-opt" class="table table-hover table-xl">
                            ...
                            <tr>
                                ...
                                <th>Status</th>
                                <th>
                                    <button type="button" data-toggle="modal" data-target="#createPostForm" id="btnCreate">
                                        Create
                                    </button>
                                </th>
                            </tr>
                            ...
                            @foreach($posts as $post)
                                <tr id="post{{$post->id}}">
                                    ...
                                    <td>
                                        <button class="btn btn-info open-modal" value="{{$post->id}}">Edit</button>
                                        <button class="btn btn-danger delete-link" value="{{$post->id}}">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
